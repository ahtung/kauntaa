...
RSpec.describe ApplicationHelper, type: :helper do
  describe '#colored_link_to' do
    ...
    it 'returns colored link with parameters id eq home-link' do
      expect(
        helper.colored_link_to(
          'Home',
          '/',
          id: 'home-link', palette: { text_color: palette.text_color, foreground_color: palette.foreground_color })
      ).to eq(
    ...
    it 'returns colored link with parameters class eq home-link' do
      expect(
        helper.colored_link_to(
          'Home',
          '/',
          class: 'home-link', palette: { text_color: palette.text_color, foreground_color: palette.foreground_color })
      ).to eq(
    ...
    it 'returns colored link with parameters remote eq true' do
      expect(
        helper.colored_link_to(
          'Home',
          '/',
          remote: true, palette: { text_color: palette.text_color, foreground_color: palette.foreground_color })
      ).to eq(
